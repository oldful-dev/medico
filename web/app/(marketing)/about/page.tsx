  ...
  return (
    <div className="bg-[#FFFCF6] min-h-screen pt-12 md:pt-16 pb-16 px-6 md:px-12 lg:px-24 font-[var(--font-poppins)]">
      <div className="max-w-4xl mx-auto flex flex-col gap-12">
        <section>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">About Ayuxa</h1>
          ...
          <div className="flex flex-col gap-8">
            <div>
              ...
              <ul className="list-none flex flex-col gap-2 text-gray-600">
                ...
                <li><strong className="text-gray-800">Email:</strong> <a href="mailto:compliance@Ayuxa.com" className="text-[var(--color-primary)] hover:underline">compliance@Ayuxa.com</a></li>
                <li><strong className="text-gray-800">Mobile:</strong> +91 80621 80429</li>
                <li><strong className="text-gray-800">Website:</strong> www.Ayuxa.com</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-none flex flex-col gap-2 text-gray-600">
                ...
                <li><strong className="text-gray-800">Email:</strong> compliance@Ayuxa.com</li>
              </ul>
            </div>
          </div>
        </section>
