  ...
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      <section className="w-full bg-[var(--color-bg-screen)] py-24 px-8 flex flex-col items-center justify-center text-center">
         ...
         <button className="bg-[var(--color-primary)] text-white font-bold text-lg px-8 py-4 rounded-full shadow-xl hover:scale-105 transition-transform active:scale-95">
           Get Started Now
         </button>
      </section>
    </div>
