...
import { Heart, Globe, Users, Gift, Smile } from 'lucide-react';
        ...
        if (json.success && json.data) {
          ...
          if (found && found.configJson) {
            ...
            if (parsed?.community_content) {
              ...
              setContent({
                title: cc.title || "Community Care",
                description: cc.description || "At Ayuxa, we believe that quality elder care is a basic human right, not just a luxury. Our Community Care initiative is dedicated to reaching those who need us most but can afford us least.",
