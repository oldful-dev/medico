...
export const metadata: Metadata = {
  title: "Community Care & Charity | Ayuxa",
  description: "Ayuxa's commitment to providing elderly care to the underprivileged and giving back to the community.",
};
      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-12">
        ...
        <header className="text-center mb-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            At Ayuxa, we believe that quality elder care is a basic human right, not just a luxury. Our Community Care initiative is dedicated to reaching those who need us most but can afford us least.
          </p>
        </header>
