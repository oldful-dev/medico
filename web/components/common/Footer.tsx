      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <a href="mailto:compliance@Ayuxa.com" className="text-sm text-[var(--color-primary)] hover:text-white transition-colors">
          ...
          <div className="flex flex-wrap gap-4 mt-2">
            {/* Facebook */}
            <a href="https://www.facebook.com/Ayuxa/" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-[var(--color-primary)] hover:text-white transition-all text-gray-400">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/company/Ayuxa/" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-[var(--color-primary)] hover:text-white transition-all text-gray-400">
