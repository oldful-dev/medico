...
export const SERVICES_CONFIG: Record<string, ServiceConfig> = {
  ...
  'hospital-trip': {
    ...
    category: 'medical',
    description: 'Don\'t go to the hospital alone. Our Ayuxa buddies will accompany you, help with paperwork, and stay with you throughout your appointment.',
  ...
  'smart-upgrade': {
    ...
    faqs: [],
    formFields: [
      { id: 'plan', label: 'Selected Plan', type: 'select', options: ['Ayuxa Homemaker Plan'], required: true }
    ]
  }
};
