...
exports.joinWaitlist = async (req, res, next) => {
    try {
        ...
        const emailSubject = isCityWaitlist
            ...
            : "You're on the Ayuxa Wellness waitlist 🎉";
        const emailHtml = `
            <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 12px; overflow: hidden;">
                ...
                <div style="padding: 30px; background-color: #ffffff;">
                    ...
                    <p style="font-size: 16px; color: #555555; line-height: 1.6;">
                        ${isCityWaitlist
                            ? `Thanks for your interest in Ayuxa services in <strong>${city || 'your city'}</strong>! We're working hard to expand there and you'll be the <strong>first to know</strong> when we launch.`
                            : `Thanks for joining the Ayuxa Wellness waitlist. We're thrilled to have you with us!`
                        }
                    </p>
                    <p style="font-size: 16px; color: #555555; line-height: 1.6;">
                        ${isCityWaitlist
                            ? `We'll send you an exclusive early-access invite as soon as Ayuxa goes live in <strong>${city || 'your city'}</strong>.`
                    ...
                    <div style="margin: 30px 0; text-align: center;">
                        <a href="https://ayuxa.vercel.app/app/services" style="background-color: #048357; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block;">Explore Our Services</a>
                    </div>
