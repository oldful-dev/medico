    ...
    sections: [
      {
        ...
        fields: [{
          ...
          options: [
            ...
            { id: 'Spouse', label: 'Spouse', icon_key: 'family_icon', sort_order: 2 },
            { id: 'Parent', label: 'Parent', icon_key: 'family_icon', sort_order: 3 },
          ],
        }],
      },
      {
    ...
    sections: [
      {
        ...
        fields: [{
          ...
          columns: 3,
          options: [
            { id: 'eye', label: 'Eye Specialist', icon_key: 'spec_eye', sort_order: 1 },
            { id: 'brain', label: 'Brain & Nerves', icon_key: 'spec_brain', sort_order: 2 },
            { id: 'kidney', label: 'Kidney & Urinary', icon_key: 'spec_kidney', sort_order: 3 },
            { id: 'lungs', label: 'Lungs & Breathing', icon_key: 'spec_lungs', sort_order: 4 },
            { id: 'dental', label: 'Dental Care', icon_key: 'spec_dental', sort_order: 5 },
            { id: 'cancer', label: 'Cancer Specialist', icon_key: 'spec_cancer', sort_order: 6 },
          ],
        }],
      },
      {
