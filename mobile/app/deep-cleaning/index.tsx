...
export default function DeepCleaningScreen() {
    ...
    const [serviceName, setServiceName] = React.useState('Deep Cleaning');
        ...
        (async () => {
            try {
                ...
                if (serviceRes.success && serviceRes.data) {
                    ...
                    if (svc) { setServiceId(svc.id); setServiceName(svc.name || 'Deep Cleaning'); setServicePrice(svc.basePrice ?? 0); }
                }
