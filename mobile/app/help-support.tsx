    ...
    const handleSubmitTicket = async () => {
        ...
        try {
            ...
            if (res.success && res.data) {
                ...
                Alert.alert(
                    'Ticket Raised',
                    `Ticket ${res.data.ticketCode} submitted. We'll respond within 48 hours.`
                );
            } else {
                    ...
                    {searchQuery.length > 0 ? (
                        ...
                        <>
                            <Text style={styles.pageDescription}>
                                {helpSupportConfig.page_description}
                            </Text>
                            ...
                            <View style={styles.infoCard}>
                                {helpSupportConfig.contacts.map((contact, i) => (
                                    <React.Fragment key={contact.id}>
                                        ...
                                        <Text style={styles.contactHeader}>{contact.label}</Text>
                                        {contact.name  && <Text style={styles.contactDetail}>Name: {contact.name}</Text>}
            ...
            <Modal visible={showModal} animationType="slide" transparent onRequestClose={() => setShowModal(false)}>
                <View style={styles.modalOverlay}>
                    <View style={styles.modalSheet}>
                        ...
                        <KeyboardAwareScrollView showsVerticalScrollIndicator={false} enableOnAndroid={true} extraScrollHeight={20} keyboardShouldPersistTaps="handled">
