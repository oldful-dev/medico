...
export default function CartScheduleScreen() {
  ...
  const selectedIds = params.selectedItemIds
    ? params.selectedItemIds.split(",")
    : [];
          ...
          <View style={{ marginBottom: 12 }}>
            ...
            >
                ...
                return (
                  ...
                  >
                    <Ionicons
                      name="location"
                      size={13}
                      color={isSelected ? "#FFFFFF" : PRIMARY_GREEN}
                      style={{ marginRight: 4 }}
                    />
                    <Text
                      style={[
                        styles.savedAddrChipText,
                        isSelected && styles.savedAddrChipTextActive,
                      ]}
                      numberOfLines={1}
                    >
              ...
              <TouchableOpacity
                style={[
                  styles.savedAddrChip,
                  addingNewAddr && styles.savedAddrChipActive,
                  { borderStyle: "dashed" },
                ]}
                onPress={() => {
                  setAddingNewAddr((v) => !v);
                  setSelectedAddress("");
                }}
                activeOpacity={0.75}
              >
                <Ionicons
                  name="add"
                  size={13}
                  color={addingNewAddr ? "#FFFFFF" : PRIMARY_GREEN}
                  style={{ marginRight: 4 }}
                />
                <Text
                  style={[
              ...
              <View style={styles.labelRow}>
                {["Home", "Office", "Other"].map((lbl) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.labelChip,
                      newAddrLabel === lbl && styles.labelChipActive,
                    ]}
              ...
              <View style={{ flexDirection: "row", gap: 10, marginTop: 4 }}>
                ...
                <TouchableOpacity
                  style={[
                    ...
                    { flex: 1 },
                    savingNewAddr && styles.continueButtonDisabled,
                  ]}
      ...
      <View style={styles.summaryCard}>
        ...
        {cartItems.map((item, idx) => (
          <View key={idx} style={[styles.summaryRow, styles.summaryRowDivider]}>
            <Text
              style={[styles.summaryLabel, { fontSize: 12 }]}
              numberOfLines={1}
            >
              {item.title}
            </Text>
