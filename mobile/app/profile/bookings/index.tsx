...
const makeStyles = (isDarkMode: boolean, colors: ThemeColors) => StyleSheet.create({
    container: { flex: 1, backgroundColor: isDarkMode ? '#1A1A1A' : '#F5F0E1' },
    header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 12, backgroundColor: isDarkMode ? '#252525' : '#FAF7ED', borderBottomWidth: 1, borderBottomColor: isDarkMode ? '#3A3A3A' : CARD_BORDER },
    headerTitle: { fontSize: 16, fontWeight: '600', color: TEXT_DARK, flex: 1, textAlign: 'center' },
    tabsScroll: { backgroundColor: isDarkMode ? '#252525' : '#FAF7ED', borderBottomWidth: 1, borderBottomColor: isDarkMode ? '#3A3A3A' : CARD_BORDER },
    ...
    tabTextActive: { color: '#FAF7ED', fontWeight: '600' },
    listContent: { padding: 16, paddingBottom: 40 },
    card: { backgroundColor: isDarkMode ? '#252525' : '#FAF7ED', borderRadius: 12, borderWidth: 1, borderColor: isDarkMode ? '#3A3A3A' : CARD_BORDER, marginBottom: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 1 },
    ...
    cardFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 12, backgroundColor: isDarkMode ? '#1F1F1F' : '#F5F0E1', borderBottomLeftRadius: 12, borderBottomRightRadius: 12, borderTopWidth: 1, borderTopColor: isDarkMode ? '#3A3A3A' : '#F3F4F6' },
    ...
    actionBtnText: { color: '#FAF7ED', fontSize: 12, fontWeight: '600' },
    ...
    outlineBtn: { borderWidth: 1, borderColor: isDarkMode ? '#3A3A3A' : CARD_BORDER, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 6, backgroundColor: isDarkMode ? 'transparent' : '#FAF7ED' },
