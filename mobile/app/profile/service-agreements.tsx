...
export default function ServiceAgreementsScreen() {
    ...
    const fetchServicePolicy = async () => {
        setLoading(true);
        try {
            const res = await legalService.getPublishedDocument('SERVICE_POLICY');
    ...
    return (
        <View style={styles.screen}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>{t('account.service_agreements') || 'Service Agreements'}</Text>
            </View>
            ...
            {loading ? (
                ...
                <View style={styles.center}>
                    ...
                    <TouchableOpacity style={styles.retryButton} onPress={fetchServicePolicy}>
