...
export const HOME_CONFIG_FALLBACK: HomeConfig = {
    ...
    sections: [
        ...
        },
        {
            ...
            services: [
                { id: 'ac_repair',     label: 'AC\nRepair',     icon: 'fa6360cf6179cebaed29a6c808bafae2d31ad753.png', route: '/appliance-repair',    enabled: true, sort_order: 1 },
...
export const sduiService = {
    /**
     * Initialize Remote Config (call once on app start).
     * Safe to call multiple times — idempotent.
     */
    init: initRemoteConfig,

    /**
     * Read the full home_config JSON from Firebase Remote Config.
     *
     * Returns the fallback config if:
     *  - Firebase is unavailable
     *  - Key is missing / empty
     *  - JSON is malformed
     *
     * Sections and services are returned sorted by sort_order
     * with disabled items already filtered out.
     */
