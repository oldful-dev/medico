  ...
  screens: {
    ...
    plans: {
      banner: {
        ...
        subtitle: "Subscribe and save with our exclusive ayuxacare plans.",
      },
      plans: [
        {
          id: "care_plan",
    ...
    help_support: {
      ...
      page_description:
        "Our support team is available to help with bookings, services, and payments.",
      contacts: [
        {
          id: "customer_support",
      ...
      support_promise: [
        {
          id: "ack",
          text: "Acknowledgement within 48 hours",
          ionicon: "checkmark-circle",
        },
        {
          id: "resolve",
          text: "Resolution within 1 month",
          ionicon: "checkmark-circle",
        },
        {
          id: "track",
          text: "A unique ticket number is provided to track your request.",
